@echo off
echo ===================================
echo PUBLIC VERCEL TEAM DEPLOYMENT
echo ===================================
echo.
...
REM Write vercel.json with explicit public access settings
echo Writing vercel.json with explicit access settings...
(
echo {
echo   "version": 2,
echo   "public": true,
...
echo   "rewrites": [
echo     { "source": "/api/(.*)", "destination": "https://api-auto-agi-builder.vercel.app/api/$1" },
...
echo ===================================
echo.
echo NOTE: This deployment is configured for:
echo - Public access (no login required)
echo - Production deployment (--prod flag)
echo.
