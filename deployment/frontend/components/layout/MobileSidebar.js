...
const MobileSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const linkClass = (href) => {
    return `flex items-center px-4 py-2 text-base font-medium rounded-md ${
      isActive(href)
  ...
  const iconClass = (href) => {
    return `mr-4 flex-shrink-0 h-6 w-6 ${
      isActive(href)
      ...
      >
        ...
        >
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white dark:bg-gray-800">
            ...
            {/* Project selection (if a project is active) */}
            {currentProject && (
              <div className="px-4 py-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center">
                  <div className="flex-shrink-0 h-8 w-8 bg-blue-600 rounded-md flex items-center justify-center text-white font-bold">
            ...
            <div className="flex-1 h-0 overflow-y-auto">
              <nav className="px-2 py-4 space-y-8">
                ...
                {currentProject && (
                  <div>
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      <button
                        className={linkClass('/device-preview')}
                        onClick={() => handleNavigate('/device-preview')}
                      >
                ...
                {currentProject && (
                  <div>
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      <button
                        className={linkClass('/demo-data')}
                        onClick={() => handleNavigate('/demo-data')}
                      >
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-1">
                    <button
                      className={linkClass('/documentation')}
            ...
            <div className="flex-shrink-0 p-4 border-t border-gray-200 dark:border-gray-700">
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Auto AGI Builder v1.0.0
              </p>
            </div>
          </div>
        </Transition.Child>
        
        {/* Empty area to close sidebar by tapping */}
