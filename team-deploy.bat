...
echo Please configure your Vercel token and team name:
echo - Get a token from https://vercel.com/account/tokens
echo - Create a team at https://vercel.com/dashboard
echo.
...
git commit -m "Configure deployment for public access with team settings"
...
vercel link --scope %VERCEL_SCOPE% --confirm
